...
function e(t, e, s) {
  if (t && t.length) {
    ...
    t.forEach(t => {
      const [e, s] = t;
      t[0] = (e - n) * h - (s - i) * o + n, t[1] = (e - n) * o + (s - i) * h + i;
    });
  }
}
  ...
  parseData(t) {
    ...
    for (this.segments = new Array(); !n(a, this.EOD);) {
      ...
      if ("BOD" === h) {
        ...
        s++, o = i[a.text], h = a.text;
      } else n(a, this.NUMBER) ? o = i[h] : (s++, o = i[a.text], h = a.text);

      if (s + o < e.length) {
        for (let t = s; t < s + o; t++) {
          const s = e[t];
          if (!n(s, this.NUMBER)) return void console.error("Param not a number: " + h + "," + s.text);
          r[r.length] = +s.text;
        }

        if ("number" != typeof i[h]) return void console.error("Bad segment: " + h);
        {
          const t = {
            key: h,
            data: r
          };
          this.segments.push(t), s += o, a = e[s], "M" === h && (h = "L"), "m" === h && (h = "l");
        }
...
class o {
  constructor(t, e, s, n, i, a) {
    ...
    const o = this._cosPhi * (t[0] - e[0]) / 2 + this._sinPhi * (t[1] - e[1]) / 2,
    ...
    } else l = (i === a ? -1 : 1) * Math.sqrt(c / (this._rx * this._rx * r * r + this._ry * this._ry * o * o));

    const u = l * this._rx * r / this._ry,
          p = -l * this._ry * o / this._rx;
    this._C = [0, 0], this._C[0] = this._cosPhi * u - this._sinPhi * p + (t[0] + e[0]) / 2, this._C[1] = this._sinPhi * u + this._cosPhi * p + (t[1] + e[1]) / 2, this._theta = this.calculateVectorAngle(1, 0, (o - u) / this._rx, (r - p) / this._ry);
    let f = this.calculateVectorAngle((o - u) / this._rx, (r - p) / this._ry, (-o - u) / this._rx, (-r - p) / this._ry);
    !a && f > 0 ? f -= 2 * Math.PI : a && f < 0 && (f += 2 * Math.PI), this._numSegs = Math.ceil(Math.abs(f / (Math.PI / 2))), this._delta = f / this._numSegs, this._T = 8 / 3 * Math.sin(this._delta / 4) * Math.sin(this._delta / 4) / Math.sin(this._delta / 2);
  }
  ...
  getNextSegment() {
    ...
    const t = Math.cos(this._theta),
          ...
          h = [this._from[0] + this._T * (-this._cosPhi * this._rx * e - this._sinPhi * this._ry * t), this._from[1] + this._T * (-this._sinPhi * this._rx * e + this._cosPhi * this._ry * t)],
          o = [a[0] + this._T * (this._cosPhi * this._rx * i + this._sinPhi * this._ry * n), a[1] + this._T * (this._sinPhi * this._rx * i - this._cosPhi * this._ry * n)];
...
function l(t, s) {
  ...
  const a = function (t, e) {
    ...
    if (s && s.length > 2) {
      ...
      i.sort((t, e) => t.ymin < e.ymin ? -1 : t.ymin > e.ymin ? 1 : t.x < e.x ? -1 : t.x > e.x ? 1 : t.ymax === e.ymax ? 0 : (t.ymax - e.ymax) / Math.abs(t.ymax - e.ymax));
      let a = [],
          h = i[0].ymin;
      ...
      for (; a.length || i.length;) {
        if (i.length) {
          ...
          for (let e = 0; e < i.length && !(i[e].ymin > h); e++) t = e;
        ...
        if (a = a.filter(t => !(t.edge.ymax <= h)), a.sort((t, e) => t.edge.x === e.edge.x ? 0 : (t.edge.x - e.edge.x) / Math.abs(t.edge.x - e.edge.x)), a.length > 1) for (let t = 0; t < a.length; t += 2) {
          const e = t + 1;
          if (e >= a.length) break;
          const s = a[t].edge,
                i = a[e].edge;
          n.push([[Math.round(s.x), h], [Math.round(i.x), h]]);
        }
        h += t, a.forEach(e => {
...
function c(t, e, s, n, i, a) {
  const h = [];
  let o = Math.abs(n / 2),
      r = Math.abs(i / 2);
  o += t.randOffset(.05 * o, a), r += t.randOffset(.05 * r, a);
  const l = a.hachureAngle;
  let c = a.hachureGap;
  c <= 0 && (c = 4 * a.strokeWidth);
  let p = a.fillWeight;
  p < 0 && (p = a.strokeWidth / 2);

  const f = l % 180 * (Math.PI / 180),
        d = Math.tan(f),
        g = r / o,
        y = Math.sqrt(g * d * g * d + 1),
        M = g * d / y,
        _ = 1 / y,
        k = c / (o * r / Math.sqrt(r * _ * (r * _) + o * M * (o * M)) / o);

  let x = Math.sqrt(o * o - (e - o + k) * (e - o + k));

  for (let t = e - o + k; t < e + o; t += k) {
    x = Math.sqrt(o * o - (e - t) * (e - t));
    const n = u(t, s - x, e, s, M, _, g),
          i = u(t, s + x, e, s, M, _, g);
    h.push([n, i]);
  }
...
function u(t, e, s, n, i, a, h) {
  return [-s * a - n * i + s + a * t + i * e, h * (s * i - n * a) + n + -h * i * t + h * a * e];
}
...
class p {
  ...
  fillEllipse(t, e, s, n, i) {
    return this._fillEllipse(t, e, s, n, i);
  }
  ...
  _fillEllipse(t, e, s, n, i, a = !1) {
    const h = c(this.helper, t, e, s, n, i);
    return {
      type: "fillSketch",
      ops: this.renderLines(h, i, a)
    };
  }
...
class f extends p {
  ...
  fillEllipse(t, e, s, n, i) {
    return this._fillEllipse(t, e, s, n, i, !0);
  }
...
class d extends p {
  ...
  fillEllipse(t, e, s, n, i) {
    const a = this._fillEllipse(t, e, s, n, i),
          h = Object.assign({}, i, {
      hachureAngle: i.hachureAngle + 90
    }),
          o = this._fillEllipse(t, e, s, n, h);

    return a.ops = a.ops.concat(o.ops), a;
  }
...
class g {
  ...
  fillEllipse(t, e, s, n, i) {
    ...
    const a = c(this.helper, t, e, s, n, i);
    return this.dotsOnLines(a, i);
  }
  ...
  dotsOnLines(t, e) {
    ...
    for (const h of t) {
      const t = s(h) / i,
            o = Math.ceil(t) - 1,
            r = Math.atan((h[1][1] - h[0][1]) / (h[1][0] - h[0][0]));
      ...
      for (let t = 0; t < o; t++) {
        const s = i * (t + 1),
              ...
              l = s * Math.cos(r),
              c = [h[0][0] - l, h[0][1] + o],
              u = this.helper.randOffsetWithRange(c[0] - i / 4, c[0] + i / 4, e),
              p = this.helper.randOffsetWithRange(c[1] - i / 4, c[1] + i / 4, e),
              f = this.helper.ellipse(u, p, a, a, e);
        n = n.concat(f.ops);
      }
    }
  ...
  dashedLine(t, e) {
    ...
    return t.forEach(t => {
      ...
      for (let t = 0; t < o; t++) {
        const s = t * (n + i),
              h = s + n,
              o = [l[0] + s * Math.cos(u) + r * Math.cos(u), l[1] + s * Math.sin(u) + r * Math.sin(u)],
              c = [l[0] + h * Math.cos(u) + r * Math.cos(u), l[1] + h * Math.sin(u) + r * Math.sin(u)];
        a = a.concat(this.helper.doubleLineOps(o[0], o[1], c[0], c[1], e));
      }
    }), a;
  }
...
class M {
  ...
  fillEllipse(t, e, s, n, i) {
    const a = i.hachureGap < 0 ? 4 * i.strokeWidth : i.hachureGap,
          h = i.zigzagOffset < 0 ? a : i.zigzagOffset;
    i = Object.assign({}, i, {
      hachureGap: a + h
    });
    const o = c(this.helper, t, e, s, n, i);
    return {
      type: "fillSketch",
      ops: this.zigzagLines(o, h, i)
    };
  }
  ...
  zigzagLines(t, e, n) {
    ...
    return t.forEach(t => {
      ...
      let o = t[0],
          r = t[1];
      o[0] > r[0] && (o = t[1], r = t[0]);
      const l = Math.atan((r[1] - o[1]) / (r[0] - o[0]));

      for (let t = 0; t < h; t++) {
        const s = 2 * t * e,
              a = 2 * (t + 1) * e,
              h = Math.sqrt(2 * Math.pow(e, 2)),
              r = [o[0] + s * Math.cos(l), o[1] + s * Math.sin(l)],
              c = [o[0] + a * Math.cos(l), o[1] + a * Math.sin(l)],
              u = [r[0] + h * Math.cos(l + Math.PI / 4), r[1] + h * Math.sin(l + Math.PI / 4)];
        i = i.concat(this.helper.doubleLineOps(r[0], r[1], u[0], u[1], n)), i = i.concat(this.helper.doubleLineOps(u[0], u[1], c[0], c[1], n));
      }
    }), i;
  }
...
function P(t, e, s) {
  ...
  if (n > 2) {
    ...
    for (let e = 0; e < n - 1; e++) i = i.concat(W(t[e][0], t[e][1], t[e + 1][0], t[e + 1][1], s));

    return e && (i = i.concat(W(t[n - 1][0], t[n - 1][1], t[0][0], t[0][1], s))), {
      type: "path",
      ops: i
    };
  }

  return 2 === n ? m(t[0][0], t[0][1], t[1][0], t[1][1], s) : {
    type: "path",
    ops: []
  };
}
...
function w(t, e, s, n, i) {
  return function (t, e) {
    return P(t, !0, e);
  }([[t, e], [t + s, e], [t + s, e + n], [t, e + n]], i);
}

function v(t, e) {
  const s = R(t, 1 * (1 + .2 * e.roughness), e),
        n = R(t, 1.5 * (1 + .22 * e.roughness), e);
  return {
    type: "path",
    ops: s.concat(n)
  };
...
function S(t, e, s, n, i) {
  const a = Math.sqrt(2 * Math.PI * Math.sqrt((Math.pow(s / 2, 2) + Math.pow(n / 2, 2)) / 2)),
        h = Math.max(i.curveStepCount, i.curveStepCount / Math.sqrt(200) * a),
        o = 2 * Math.PI / h;
  let r = Math.abs(s / 2),
      l = Math.abs(n / 2);
  r += A(.05 * r, i), l += A(.05 * l, i);
  const c = D(o, t, e, r, l, 1, o * C(.1, C(.4, 1, i), i), i),
        u = D(o, t, e, r, l, 1.5, 0, i);
  return {
    type: "path",
    ops: c.concat(u)
  };
...
function O(t, e, s, n, i, a, h, o, r) {
  const l = t,
        c = e;
  let u = Math.abs(s / 2),
      p = Math.abs(n / 2);
  u += A(.01 * u, r), p += A(.01 * p, r);
  let f = i,
      d = a;
  ...
  const g = 2 * Math.PI / r.curveStepCount,
        ...
        M = L(y, l, c, u, p, f, d, 1, r),
        _ = L(y, l, c, u, p, f, d, 1.5, r);

  let k = M.concat(_);
  return h && (o ? (k = k.concat(W(l, c, l + u * Math.cos(f), c + p * Math.sin(f), r)), k = k.concat(W(l, c, l + u * Math.cos(d), c + p * Math.sin(d), r))) : (k.push({
    op: "lineTo",
    data: [l, c]
  }), k.push({
    op: "lineTo",
    data: [l + u * Math.cos(f), c + p * Math.sin(f)]
  }))), {
    type: "path",
    ops: k
  };
...
function T(t, e) {
  ...
  if (t.length) {
    ...
    if (i > 2) {
      s.push({
        op: "move",
        data: [t[0][0] + A(n, e), t[0][1] + A(n, e)]
      });

      for (let a = 1; a < i; a++) s.push({
        op: "lineTo",
        data: [t[a][0] + A(n, e), t[a][1] + A(n, e)]
      });
    }
  }
...
function z(t, e) {
  return k(e, b).fillPolygon(t, e);
}

function E(t) {
  return t.randomizer || (t.randomizer = new x(t.seed || 0)), t.randomizer.next();
}

function C(t, e, s) {
  return s.roughness * s.roughnessGain * (E(s) * (e - t) + t);
}
...
function W(t, e, s, n, i) {
  const a = q(t, e, s, n, i, !0, !1),
        h = q(t, e, s, n, i, !0, !0);
  return a.concat(h);
}

function q(t, e, s, n, i, a, h) {
  const o = Math.pow(t - s, 2) + Math.pow(e - n, 2),
        r = Math.sqrt(o);
  i.roughnessGain = r < 200 ? 1 : r > 500 ? .4 : -.0016668 * r + 1.233334;
  let l = i.maxRandomnessOffset || 0;
  l * l * 100 > o && (l = r / 10);
  const c = l / 2,
        u = .2 + .2 * E(i);
  let p = i.bowing * i.maxRandomnessOffset * (n - e) / 200,
      f = i.bowing * i.maxRandomnessOffset * (t - s) / 200;
  p = A(p, i), f = A(f, i);
  ...
  return a && (h ? d.push({
    ...
    op: "move",
    data: [t + A(l, i), e + A(l, i)]
  })), h ? d.push({
    op: "bcurveTo",
    data: [p + t + (s - t) * u + g(), f + e + (n - e) * u + g(), p + t + 2 * (s - t) * u + g(), f + e + 2 * (n - e) * u + g(), s + g(), n + g()]
  }) : d.push({
    op: "bcurveTo",
    data: [p + t + (s - t) * u + y(), f + e + (n - e) * u + y(), p + t + 2 * (s - t) * u + y(), f + e + 2 * (n - e) * u + y(), s + y(), n + y()]
  }), d;
}
...
function R(t, e, s) {
  ...
  for (let i = 1; i < t.length; i++) n.push([t[i][0] + A(e, s), t[i][1] + A(e, s)]), i === t.length - 1 && n.push([t[i][0] + A(e, s), t[i][1] + A(e, s)]);
...
function I(t, e, s) {
  ...
  if (n > 3) {
    ...
    for (let e = 1; e + 2 < n; e++) {
      const s = t[e];
      a[0] = [s[0], s[1]], a[1] = [s[0] + (h * t[e + 1][0] - h * t[e - 1][0]) / 6, s[1] + (h * t[e + 1][1] - h * t[e - 1][1]) / 6], a[2] = [t[e + 1][0] + (h * t[e][0] - h * t[e + 2][0]) / 6, t[e + 1][1] + (h * t[e][1] - h * t[e + 2][1]) / 6], a[3] = [t[e + 1][0], t[e + 1][1]], i.push({
        op: "bcurveTo",
  ...
  })) : 2 === n && (i = i.concat(W(t[0][0], t[0][1], t[1][0], t[1][1], s)));

  return i;
}

function D(t, e, s, n, i, a, h, o) {
  const r = A(.5, o) - Math.PI / 2,
        l = [];
  l.push([A(a, o) + e + .9 * n * Math.cos(r - t), A(a, o) + s + .9 * i * Math.sin(r - t)]);

  for (let h = r; h < 2 * Math.PI + r - .01; h += t) l.push([A(a, o) + e + n * Math.cos(h), A(a, o) + s + i * Math.sin(h)]);

  return l.push([A(a, o) + e + n * Math.cos(r + 2 * Math.PI + .5 * h), A(a, o) + s + i * Math.sin(r + 2 * Math.PI + .5 * h)]), l.push([A(a, o) + e + .98 * n * Math.cos(r + h), A(a, o) + s + .98 * i * Math.sin(r + h)]), l.push([A(a, o) + e + .9 * n * Math.cos(r + .5 * h), A(a, o) + s + .9 * i * Math.sin(r + .5 * h)]), I(l, null, o);
}

function L(t, e, s, n, i, a, h, o, r) {
  const l = a + A(.1, r),
        c = [];
  c.push([A(o, r) + e + .9 * n * Math.cos(l - t), A(o, r) + s + .9 * i * Math.sin(l - t)]);

  for (let a = l; a <= h; a += t) c.push([A(o, r) + e + n * Math.cos(a), A(o, r) + s + i * Math.sin(a)]);

  return c.push([e + n * Math.cos(h), s + i * Math.sin(h)]), c.push([e + n * Math.cos(h), s + i * Math.sin(h)]), I(c, null, r);
}

function $(t, e, s, n, i, a, h, o) {
  const r = [],
  ...
  for (let u = 0; u < 2; u++) 0 === u ? r.push({
    ...
    op: "move",
    data: [h.x + A(l[0], o), h.y + A(l[0], o)]
  }), c = [i + A(l[u], o), a + A(l[u], o)], r.push({
    op: "bcurveTo",
    data: [t + A(l[u], o), e + A(l[u], o), s + A(l[u], o), n + A(l[u], o), c[0], c[1]]
  });

  return h.setPosition(c[0], c[1]), r;
}
...
function N(t, e, s, n) {
  ...
  switch (e.key) {
    ...
    case "m":
      {
        ...
        if (e.data.length >= 2) {
          let a = +e.data[0],
              h = +e.data[1];
          s && (a += t.x, h += t.y);
          const o = 1 * (n.maxRandomnessOffset || 0);
          a += A(o, n), h += A(o, n), t.setPosition(a, h), i.push({
            op: "move",
            data: [a, h]
          });
        }
    ...
    case "l":
      {
        ...
        if (e.data.length >= 2) {
          let a = +e.data[0],
              h = +e.data[1];
          s && (a += t.x, h += t.y), i = i.concat(W(t.x, t.y, a, h, n)), t.setPosition(a, h);
        }
    ...
    case "h":
      {
        ...
        if (e.data.length) {
          let a = +e.data[0];
          s && (a += t.x), i = i.concat(W(t.x, t.y, a, t.y, n)), t.setPosition(a, t.y);
        }
    ...
    case "v":
      {
        ...
        if (e.data.length) {
          let a = +e.data[0];
          s && (a += t.y), i = i.concat(W(t.x, t.y, t.x, a, n)), t.setPosition(t.x, a);
        }
    ...
    case "Z":
    case "z":
      t.first && (i = i.concat(W(t.x, t.y, t.first[0], t.first[1], n)), t.setPosition(t.first[0], t.first[1]), t.first = null);
      break;
    ...
    case "c":
      {
        ...
        if (e.data.length >= 6) {
          let a = +e.data[0],
              ...
              l = +e.data[4],
              c = +e.data[5];
          s && (a += t.x, o += t.x, l += t.x, h += t.y, r += t.y, c += t.y);
          const u = $(a, h, o, r, l, c, t, n);
          i = i.concat(u), t.bezierReflectionPoint = [l + (l - o), c + (c - r)];
        }
    ...
    case "s":
      {
        ...
        if (e.data.length >= 4) {
          let h = +e.data[0],
              ...
              r = +e.data[2],
              l = +e.data[3];
          a && (h += t.x, r += t.x, o += t.y, l += t.y);
          let c = h,
              u = o;
          const p = s ? s.key : "";
          let f = null;
          "c" !== p && "C" !== p && "s" !== p && "S" !== p || (f = t.bezierReflectionPoint), f && (c = f[0], u = f[1]);
          const d = $(c, u, h, o, r, l, t, n);
          i = i.concat(d), t.bezierReflectionPoint = [r + (r - h), l + (l - o)];
        }
    ...
    case "q":
      {
        ...
        if (e.data.length >= 4) {
          let a = +e.data[0],
              ...
              o = +e.data[2],
              r = +e.data[3];
          s && (a += t.x, o += t.x, h += t.y, r += t.y);
          const l = 1 * (1 + .2 * n.roughness),
                c = 1.5 * (1 + .22 * n.roughness);
          i.push({
            op: "move",
            data: [t.x + A(l, n), t.y + A(l, n)]
          });
          let u = [o + A(l, n), r + A(l, n)];
          i.push({
            op: "qcurveTo",
            data: [a + A(l, n), h + A(l, n), u[0], u[1]]
          }), i.push({
            op: "move",
            data: [t.x + A(c, n), t.y + A(c, n)]
          }), u = [o + A(c, n), r + A(c, n)], i.push({
            op: "qcurveTo",
            data: [a + A(c, n), h + A(c, n), u[0], u[1]]
          }), t.setPosition(u[0], u[1]), t.quadReflectionPoint = [o + (o - a), r + (r - h)];
        }
    ...
    case "t":
      {
        ...
        if (e.data.length >= 2) {
          ...
          const c = s ? s.key : "";
          let u = null;
          "q" !== c && "Q" !== c && "t" !== c && "T" !== c || (u = t.quadReflectionPoint), u && (r = u[0], l = u[1]);
          const p = 1 * (1 + .2 * n.roughness),
                f = 1.5 * (1 + .22 * n.roughness);
          i.push({
            op: "move",
            data: [t.x + A(p, n), t.y + A(p, n)]
          });
          let d = [h + A(p, n), o + A(p, n)];
          i.push({
            op: "qcurveTo",
            data: [r + A(p, n), l + A(p, n), d[0], d[1]]
          }), i.push({
            op: "move",
            data: [t.x + A(f, n), t.y + A(f, n)]
          }), d = [h + A(f, n), o + A(f, n)], i.push({
            op: "qcurveTo",
            data: [r + A(f, n), l + A(f, n), d[0], d[1]]
          }), t.setPosition(d[0], d[1]), t.quadReflectionPoint = [h + (h - r), o + (o - l)];
        }
    ...
    case "a":
      {
        ...
        if (e.data.length >= 7) {
          ...
          if (0 === a || 0 === h) i = i.concat(W(t.x, t.y, u, p, n)), t.setPosition(u, p);else for (let e = 0; e < 1; e++) {
            const e = new o([t.x, t.y], [u, p], [a, h], r, !!l, !!c);
            let s = e.getNextSegment();

            for (; s;) {
              const a = $(s.cp1[0], s.cp1[1], s.cp2[0], s.cp2[1], s.to[0], s.to[1], t, n);
...
class j {
  ...
  line(t, e, s, n, i) {
    ...
    return this._drawable("line", [m(t, e, s, n, a)], a);
  }
  ...
  rectangle(t, e, s, n, i) {
    ...
    if (a.fill) {
      const i = [[t, e], [t + s, e], [t + s, e + n], [t, e + n]];
      "solid" === a.fillStyle ? h.push(T(i, a)) : h.push(z(i, a));
    }

    return a.stroke !== G && h.push(o), this._drawable("rectangle", h, a);
  }
  ...
  ellipse(t, e, s, n, i) {
    ...
    if (a.fill) if ("solid" === a.fillStyle) {
      const i = S(t, e, s, n, a);
      i.type = "fillPath", h.push(i);
    } else h.push(function (t, e, s, n, i) {
      return k(i, b).fillEllipse(t, e, s, n, i);
    }(t, e, s, n, a));
    return a.stroke !== G && h.push(o), this._drawable("ellipse", h, a);
  }
  ...
  linearPath(t, e) {
    ...
    return this._drawable("linearPath", [P(t, !1, s)], s);
  }

  arc(t, e, s, n, i, a, h = !1, o) {
    const r = this._options(o),
          l = [],
          c = O(t, e, s, n, i, a, h, !0, r);

    if (h && r.fill) if ("solid" === r.fillStyle) {
      const h = O(t, e, s, n, i, a, !0, !1, r);
      h.type = "fillPath", l.push(h);
    } else l.push(function (t, e, s, n, i, a, h) {
      const o = t,
            r = e;
      let l = Math.abs(s / 2),
          c = Math.abs(n / 2);
      l += A(.01 * l, h), c += A(.01 * c, h);
      let u = i,
          p = a;
      ...
      for (let t = u; t <= p; t += f) d.push([o + l * Math.cos(t), r + c * Math.sin(t)]);

      return d.push([o + l * Math.cos(p), r + c * Math.sin(p)]), d.push([o, r]), z(d, h);
    }(t, e, s, n, i, a, r));
    return r.stroke !== G && l.push(c), this._drawable("arc", l, r);
  }

  curve(t, e) {
    const s = this._options(e);

    return this._drawable("curve", [v(t, s)], s);
  }
  ...
  polygon(t, e) {
    ...
    return s.fill && ("solid" === s.fillStyle ? n.push(T(t, s)) : n.push(z(t, s))), s.stroke !== G && n.push(i), this._drawable("polygon", n, s);
  }
  ...
  path(t, e) {
    ...
    const i = function (t, e) {
      ...
      for (let t = 0; t < i.length; t++) {
        const a = N(s, i[t], t > 0 ? i[t - 1] : null, e);
    ...
    if (s.fill) if ("solid" === s.fillStyle) {
      ...
      const e = this.computePathSize(t),
            i = z([[0, 0], [e[0], 0], [e[0], e[1]], [0, e[1]]], s);
      i.type = "path2Dpattern", i.size = e, i.path = t, n.push(i);
    }
    return s.stroke !== G && n.push(i), this._drawable("path", n, s);
  }

  computePathSize(e) {
    let s = [0, 0];
    if (B && self.document) try {
...
class Q {
  constructor(t, e) {
    this.canvas = t, this.ctx = this.canvas.getContext("2d"), this.gen = new j(e, this.canvas);
  }
  ...
  draw(t) {
    ...
    for (const t of e) switch (t.type) {
      case "path":
        n.save(), n.strokeStyle = "none" === s.stroke ? "transparent" : s.stroke, n.lineWidth = s.strokeWidth, this._drawToContext(n, t), n.restore();
        break;
      ...
      case "path2Dpattern":
        {
          ...
          if (e) {
            const n = t.size,
                  ...
                  a = i.getContext("2d"),
                  h = this.computeBBox(t.path);
            h && (h.width || h.height) ? (i.width = this.canvas.width, i.height = this.canvas.height, a.translate(h.x || 0, h.y || 0)) : (i.width = n[0], i.height = n[1]), this.fillSketch(a, t, s), this.ctx.save(), this.ctx.fillStyle = this.ctx.createPattern(i, "repeat");
  ...
  arc(t, e, s, n, i, a, h = !1, o) {
    const r = this.gen.arc(t, e, s, n, i, a, h, o);
...
class Z {
  constructor(t, e) {
    this.svg = t, this.gen = new j(e, this.svg);
  }

  get defs() {
    const e = this.svg.ownerDocument || U && document;
  ...
  draw(e) {
    ...
    for (const e of s) {
      ...
      switch (e.type) {
        case "path":
          s = i.createElementNS(t, "path"), s.setAttribute("d", this.opsToPath(e)), s.style.stroke = n.stroke, s.style.strokeWidth = n.strokeWidth + "", s.style.fill = "none";
          break;

        case "fillPath":
          s = i.createElementNS(t, "path"), s.setAttribute("d", this.opsToPath(e)), s.style.stroke = "none", s.style.strokeWidth = "0", s.style.fill = n.fill || "";
          break;
        ...
        case "path2Dfill":
          s = i.createElementNS(t, "path"), s.setAttribute("d", e.path || ""), s.style.stroke = "none", s.style.strokeWidth = "0", s.style.fill = n.fill || "";
          break;

        case "path2Dpattern":
          if (this.defs) {
            const a = e.size,
                  h = i.createElementNS(t, "pattern"),
                  o = `rough-${Math.floor(Math.random() * (Number.MAX_SAFE_INTEGER || 999999))}`;
            h.setAttribute("id", o), h.setAttribute("x", "0"), h.setAttribute("y", "0"), h.setAttribute("width", "1"), h.setAttribute("height", "1"), h.setAttribute("height", "1"), h.setAttribute("viewBox", `0 0 ${Math.round(a[0])} ${Math.round(a[1])}`), h.setAttribute("patternUnits", "objectBoundingBox");
            const r = this.fillSketch(i, e, n);
            h.appendChild(r), this.defs.appendChild(h), s = i.createElementNS(t, "path"), s.setAttribute("d", e.path || ""), s.style.stroke = "none", s.style.strokeWidth = "0", s.style.fill = `url(#${o})`;
          } else console.error("Pattern fill fail: No defs");
...
},{}],"../src/utils/addFonts.js":[function(require,module,exports) {
/* eslint-disable max-len*/
var addFontGaegu = function addFontGaegu(parent) {
...
var addFontIndieFlower = function addFontIndieFlower(parent) {
...
module.exports = {
  addFontGaegu: addFontGaegu,
  addFontIndieFlower: addFontIndieFlower
};
...
var _addFonts = require("./utils/addFonts");
...
function () {
  function Chart(opts) {
    ...
    this.font = (0, _lodash.default)(opts, 'font', 0);
    this.fillStyle = opts.fillStyle;
    this.tooltipFontSize = (0, _lodash.default)(opts, 'tooltipFontSize', '0.95rem');
    this.bowing = (0, _lodash.default)(opts, 'bowing', 0);
    this.simplification = (0, _lodash.default)(opts, 'simplification', 0.2);
    this.interactive = opts.interactive !== false;
    this.dataFormat = _typeof(opts.data) === 'object' ? 'object' : 'file';
  }
  ...
  _createClass(Chart, [{
    ...
    key: "resolveFont",
    value: function resolveFont() {
      if (this.font === 0 || this.font === undefined || this.font.toString().toLowerCase() === 'gaegu') {
        (0, _addFonts.addFontGaegu)(this.svg);
        this.fontFamily = 'gaeguregular';
      } else if (this.font === 1 || this.font.toString().toLowerCase() === 'indie flower') {
        (0, _addFonts.addFontIndieFlower)(this.svg);
...
var _default = Chart;
exports.default = _default;
},{"d3-selection":"../node_modules/d3-selection/src/index.js","lodash.get":"../node_modules/lodash.get/index.js","./utils/addFonts":"../src/utils/addFonts.js"}],"../src/utils/roughCeiling.js":[function(require,module,exports) {
var DEFAULT_CEILING = 20;
var DEFAULT_VALUE = 1;

var roughCeiling = function roughCeiling(_ref) {
  var roughness = _ref.roughness,
      _ref$ceiling = _ref.ceiling,
      ceiling = _ref$ceiling === void 0 ? DEFAULT_CEILING : _ref$ceiling,
      _ref$defaultValue = _ref.defaultValue,
      defaultValue = _ref$defaultValue === void 0 ? DEFAULT_VALUE : _ref$defaultValue;
  if (roughness === undefined || typeof roughness !== 'number') return defaultValue;
  return roughness > ceiling ? ceiling : roughness;
};

module.exports = {
  roughCeiling: roughCeiling,
...
var _roughEsm = _interopRequireDefault(require("roughjs/bundled/rough.esm.js"));

var _lodash = _interopRequireDefault(require("lodash.get"));

var _Chart2 = _interopRequireDefault(require("./Chart"));

var _roughCeiling = require("./utils/roughCeiling");
...
function (_Chart) {
  ...
  function Bar(opts) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Bar).call(this, opts)); // load in arguments from config object

    _this.data = opts.data;
    _this.margin = opts.margin || {
      top: 50,
      right: 20,
      bottom: 70,
      left: 100
    };
    _this.color = (0, _lodash.default)(opts, 'color', 'skyblue');
    _this.highlight = (0, _lodash.default)(opts, 'highlight', 'coral');
    _this.roughness = (0, _roughCeiling.roughCeiling)({
      roughness: opts.roughness
    });
    _this.stroke = (0, _lodash.default)(opts, 'stroke', 'black');
    _this.strokeWidth = (0, _lodash.default)(opts, 'strokeWidth', 1);
    _this.axisStrokeWidth = (0, _lodash.default)(opts, 'axisStrokeWidth', 0.5);
    _this.axisRoughness = (0, _lodash.default)(opts, 'axisRoughness', 0.5);
    _this.innerStrokeWidth = (0, _lodash.default)(opts, 'innerStrokeWidth', 1);
    _this.fillWeight = (0, _lodash.default)(opts, 'fillWeight', 0.5);
    _this.axisFontSize = opts.axisFontSize;
    _this.labels = _this.dataFormat === 'object' ? 'labels' : opts.labels;
    _this.values = _this.dataFormat === 'object' ? 'values' : opts.values;
    _this.xValueFormat = opts.xValueFormat;
    _this.yValueFormat = opts.yValueFormat;
    _this.padding = (0, _lodash.default)(opts, 'padding', 0.1);
    _this.xLabel = (0, _lodash.default)(opts, 'xLabel', '');
    _this.yLabel = (0, _lodash.default)(opts, 'yLabel', '');
    _this.labelFontSize = (0, _lodash.default)(opts, 'labelFontSize', '1rem'); // new width

    _this.initChartValues(opts); // resolve font


    _this.resolveFont(); // create the chart


    _this.drawChart = _this.resolveData(opts.data);

    _this.drawChart();

    if (opts.title !== 'undefined') _this.setTitle(opts.title);
    return _this;
  }
  ...
  _createClass(Bar, [{
    ...
    value: function addScales() {
      var that = this;
      this.xScale = (0, _d3Scale.scaleBand)().rangeRound([0, this.width]).padding(this.padding).domain(this.dataFormat === 'file' ? this.data.map(function (d) {
        return d[that.labels];
      }) : this.data[that.labels]);
      this.yScale = (0, _d3Scale.scaleLinear)().rangeRound([this.height, 0]).domain(this.dataFormat === 'file' ? [0, (0, _d3Array.max)(this.data, function (d) {
        return +d[that.values];
      })] : [0, (0, _d3Array.max)(this.data[that.values])]);
    }
  }, {
    key: "addLabels",
    value: function addLabels() {
      // xLabel
      if (this.xLabel !== '') {
        this.svg.append('text').attr('x', this.width / 2).attr('y', this.height + this.margin.bottom / 2).attr('dx', '1em').attr('class', 'labelText').style('text-anchor', 'middle').style('font-family', this.fontFamily).style('font-size', this.labelFontSize).text(this.xLabel);
      }

      ; // yLabel

      if (this.yLabel !== '') {
        this.svg.append('text').attr('transform', 'rotate(-90)').attr('y', 0 - this.margin.left / 1.4).attr('x', 0 - this.height / 2).attr('dy', '1em').attr('class', 'labelText').style('text-anchor', 'middle').style('font-family', this.fontFamily).style('font-size', this.labelFontSize).text(this.yLabel);
      }
    ...
    value: function addAxes() {
      ...
      var xAxis = (0, _d3Axis.axisBottom)(this.xScale).tickSize(0).tickFormat(function (d) {
        return _this3.xValueFormat ? (0, _d3Format.format)(_this3.xValueFormat)(d) : d;
      });
      var yAxis = (0, _d3Axis.axisLeft)(this.yScale).tickSize(0).tickFormat(function (d) {
        return _this3.yValueFormat ? (0, _d3Format.format)(_this3.yValueFormat)(d) : d;
      }); // x-axis

      this.svg.append('g').attr('transform', 'translate(0,' + this.height + ')').call(xAxis).attr('class', "xAxis".concat(this.graphClass)).selectAll('text').attr('transform', 'translate(-10,0)rotate(-45)').style('text-anchor', 'end').style('font-family', this.fontFamily).style('font-size', this.axisFontSize === undefined ? "".concat(Math.min(0.8, Math.min(this.width, this.height) / 140), "rem") : this.axisFontSize).style('opacity', 0.9); // y-axis

      this.svg.append('g').call(yAxis).attr('class', "yAxis".concat(this.graphClass)).selectAll('text').style('font-family', this.fontFamily).style('font-size', this.axisFontSize === undefined ? "".concat(Math.min(0.95, Math.min(this.width, this.height) / 140), "rem") : this.axisFontSize).style('opacity', 0.9); // hide original axes
    ...
    value: function setTitle(title) {
      this.svg.append('text').attr('x', this.width / 2).attr('y', 0 - this.margin.top / 2).attr('class', 'title').attr('text-anchor', 'middle').style('font-size', this.titleFontSize === undefined ? "".concat(Math.min(40, Math.min(this.width, this.height) / 5), "px") : this.titleFontSize).style('font-family', this.fontFamily).style('opacity', 0.8).text(title);
    }
  }, {
    key: "addInteraction",
    value: function addInteraction() {
      ...
      (0, _d3Selection.selectAll)(this.interactionG).data(this.dataFormat === 'file' ? this.data : this.data.values).append('rect').attr('x', function (d, i) {
        return _this4.dataFormat === 'file' ? _this4.xScale(d[_this4.labels]) : _this4.xScale(_this4.data[_this4.labels][i]);
      }).attr('y', function (d, i) {
        return _this4.dataFormat === 'file' ? _this4.yScale(+d[_this4.values]) : _this4.yScale(_this4.data[_this4.values][i]);
      }).attr('width', this.xScale.bandwidth()).attr('height', function (d, i) {
        return _this4.dataFormat === 'file' ? _this4.height - _this4.yScale(+d[_this4.values]) : _this4.height - _this4.yScale(_this4.data[_this4.values][i]);
      ...
      var mousemove = function mousemove(d) {
        ...
        Tooltip.html("<b>".concat(attrX, "</b>: ").concat(attrY)).style('opacity', 0.95).attr('class', function (d) {}).style('transform', "translate(".concat(mousePos[0] + that.margin.left, "px, \n          ").concat(mousePos[1] - (that.height + that.margin.top + that.margin.bottom), "px)"));
      };
      ...
      (0, _d3Selection.selectAll)(this.interactionG).on('mouseover', function () {
        ...
        (0, _d3Selection.select)(this).selectAll('path:nth-child(2)').style('stroke-width', that.strokeWidth + 1.2);
      });
      (0, _d3Selection.selectAll)(this.interactionG).on('mouseout', function () {
        ...
        (0, _d3Selection.select)(this).selectAll('path:nth-child(2)').style('stroke-width', that.strokeWidth);
      });
    ...
    value: function initRoughObjects() {
      ...
      this.rcAxis = _roughEsm.default.svg(this.roughSvg, {
        options: {
          strokeWidth: this.axisStrokeWidth,
          roughness: this.axisRoughness
        }
      });
      this.rc = _roughEsm.default.svg(this.roughSvg, {
        options: {
          fill: this.color,
    ...
    value: function drawFromObject() {
      ...
      this.addLabels(); // Add barplot

      this.data.values.forEach(function (d, i) {
        var node = _this5.rc.rectangle(_this5.xScale(_this5.data[_this5.labels][i]), _this5.yScale(+d), _this5.xScale.bandwidth(), _this5.height - _this5.yScale(+d), {
          simplification: _this5.simplification,
          fillWeight: _this5.fillWeight
        });

        var roughNode = _this5.roughSvg.appendChild(node);

        roughNode.setAttribute('class', _this5.graphClass);
        roughNode.setAttribute('attrX', _this5.data[_this5.labels][i]);
        roughNode.setAttribute('attrY', +d);
      });
      (0, _d3Selection.selectAll)(this.interactionG).selectAll('path:nth-child(2)').style('stroke-width', this.strokeWidth); // If desired, add interactivity
    ...
    value: function drawFromFile() {
      ...
      this.data.forEach(function (d) {
        var node = _this6.rc.rectangle(_this6.xScale(d[_this6.labels]), _this6.yScale(+d[_this6.values]), _this6.xScale.bandwidth(), _this6.height - _this6.yScale(+d[_this6.values]), {
          simplification: _this6.simplification,
          fillWeight: _this6.fillWeight
        });

        var roughNode = _this6.roughSvg.appendChild(node);

        roughNode.setAttribute('class', _this6.graphClass);
        roughNode.setAttribute('attrX', d[_this6.labels]);
        roughNode.setAttribute('attrY', +d[_this6.values]);
      });
      (0, _d3Selection.selectAll)(this.interactionG).selectAll('path:nth-child(2)').style('stroke-width', this.strokeWidth); // If desired, add interactivity
...
var _default = Bar;
exports.default = _default;
},{"d3-array":"../node_modules/d3-array/src/index.js","d3-axis":"../node_modules/d3-axis/src/index.js","d3-fetch":"../node_modules/d3-fetch/src/index.js","d3-format":"../node_modules/d3-format/src/index.js","d3-scale":"../node_modules/d3-scale/src/index.js","d3-selection":"../node_modules/d3-selection/src/index.js","roughjs/bundled/rough.esm.js":"../node_modules/roughjs/bundled/rough.esm.js","lodash.get":"../node_modules/lodash.get/index.js","./Chart":"../src/Chart.js","./utils/roughCeiling":"../src/utils/roughCeiling.js"}],"../src/BarH.js":[function(require,module,exports) {
"use strict";
...
function (_Chart) {
  ...
  function BarH(opts) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(BarH).call(this, opts)); // load in arguments from config object
    // this.data = opts.data;
  ...
  _createClass(BarH, [{
    ...
    value: function addScales() {
      var that = this;
      this.yScale = (0, _d3Scale.scaleBand)().rangeRound([0, this.height]).padding(this.padding).domain(this.dataFormat === 'file' ? this.data.map(function (d) {
        return d[that.labels];
      }) : this.data[that.labels]);
      this.xScale = (0, _d3Scale.scaleLinear)().rangeRound([0, this.width]).domain(this.dataFormat === 'file' ? [0, (0, _d3Array.max)(this.data, function (d) {
        return +d[that.values];
      })] : [0, (0, _d3Array.max)(this.data[that.values])]);
    }
  }, {
    ...
    value: function addLabels() {
      // xLabel
      if (this.xLabel !== '') {
        this.svg.append('text').attr('x', this.width / 2).attr('y', this.height + this.margin.bottom / 2.4).attr('dx', '1em').attr('class', 'labelText').style('text-anchor', 'middle').style('font-family', this.fontFamily).style('font-size', this.labelFontSize).text(this.xLabel);
      }

      ; // yLabel

      if (this.yLabel !== '') {
        this.svg.append('text').attr('transform', 'rotate(-90)').attr('y', 0 - this.margin.left / 1.5).attr('x', 0 - this.height / 2).attr('dy', '1em').attr('class', 'labelText').style('text-anchor', 'middle').style('font-family', this.fontFamily).style('font-size', this.labelFontSize).text(this.yLabel);
      }
    ...
    value: function addAxes() {
      ...
      this.svg.append('g').attr('transform', "translate(0, ".concat(this.height, ")")).call(xAxis).attr('class', "xAxis".concat(this.graphClass)).selectAll('text').attr('transform', 'translate(-10,0)rotate(-45)').style('text-anchor', 'end').style('font-family', this.fontFamily).style('font-size', this.axisFontSize === undefined ? "".concat(Math.min(0.95, Math.min(this.width, this.height) / 140), "rem") : this.axisFontSize).style('opacity', 0.85); // y-axis

      this.svg.append('g').call(yAxis).attr('class', "yAxis".concat(this.graphClass)).selectAll('text').style('font-family', this.fontFamily).style('font-size', this.axisFontSize === undefined ? "".concat(Math.min(0.95, Math.min(this.width, this.height) / 140), "rem") : this.axisFontSize).style('opacity', 0.85); // hide original axes
    ...
    value: function addInteraction() {
      ...
      (0, _d3Selection.selectAll)(this.interactionG).data(this.dataFormat === 'file' ? this.data : this.data.values).append('rect').attr('x', 0).attr('y', function (d, i) {
        return _this4.dataFormat === 'file' ? _this4.yScale(d[_this4.labels]) : _this4.yScale(_this4.data[_this4.labels][i]);
      }).attr('width', function (d, i) {
        return _this4.dataFormat === 'file' ? _this4.xScale(+d[_this4.values]) : _this4.xScale(_this4.data[_this4.values][i]);
    ...
    value: function drawFromObject() {
      ...
      this.addLabels();
      this.data.values.forEach(function (d, i) {
        var node = _this5.rc.rectangle(0, _this5.yScale(_this5.data[_this5.labels][i]), _this5.xScale(d), _this5.yScale.bandwidth(), {
          simplification: _this5.simplification,
          fillWeight: _this5.fillWeight
        });
    ...
    value: function drawFromFile() {
      ...
      this.data.forEach(function (d) {
        var node = _this6.rc.rectangle(0, _this6.yScale(d[_this6.labels]), _this6.xScale(+d[_this6.values]), _this6.yScale.bandwidth(), {
          simplification: _this6.simplification,
          fillWeight: _this6.fillWeight
        });
...
var _default = BarH;
exports.default = _default;
},{"d3-array":"../node_modules/d3-array/src/index.js","d3-axis":"../node_modules/d3-axis/src/index.js","d3-fetch":"../node_modules/d3-fetch/src/index.js","d3-format":"../node_modules/d3-format/src/index.js","d3-scale":"../node_modules/d3-scale/src/index.js","d3-selection":"../node_modules/d3-selection/src/index.js","roughjs/bundled/rough.esm.js":"../node_modules/roughjs/bundled/rough.esm.js","lodash.get":"../node_modules/lodash.get/index.js","./Chart":"../src/Chart.js","./utils/roughCeiling":"../src/utils/roughCeiling.js"}],"../node_modules/d3-path/src/path.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./arc":"../node_modules/d3-shape/src/arc.js","./area":"../node_modules/d3-shape/src/area.js","./line":"../node_modules/d3-shape/src/line.js","./pie":"../node_modules/d3-shape/src/pie.js","./areaRadial":"../node_modules/d3-shape/src/areaRadial.js","./lineRadial":"../node_modules/d3-shape/src/lineRadial.js","./pointRadial":"../node_modules/d3-shape/src/pointRadial.js","./link/index":"../node_modules/d3-shape/src/link/index.js","./symbol":"../node_modules/d3-shape/src/symbol.js","./symbol/circle":"../node_modules/d3-shape/src/symbol/circle.js","./symbol/cross":"../node_modules/d3-shape/src/symbol/cross.js","./symbol/diamond":"../node_modules/d3-shape/src/symbol/diamond.js","./symbol/square":"../node_modules/d3-shape/src/symbol/square.js","./symbol/star":"../node_modules/d3-shape/src/symbol/star.js","./symbol/triangle":"../node_modules/d3-shape/src/symbol/triangle.js","./symbol/wye":"../node_modules/d3-shape/src/symbol/wye.js","./curve/basisClosed":"../node_modules/d3-shape/src/curve/basisClosed.js","./curve/basisOpen":"../node_modules/d3-shape/src/curve/basisOpen.js","./curve/basis":"../node_modules/d3-shape/src/curve/basis.js","./curve/bundle":"../node_modules/d3-shape/src/curve/bundle.js","./curve/cardinalClosed":"../node_modules/d3-shape/src/curve/cardinalClosed.js","./curve/cardinalOpen":"../node_modules/d3-shape/src/curve/cardinalOpen.js","./curve/cardinal":"../node_modules/d3-shape/src/curve/cardinal.js","./curve/catmullRomClosed":"../node_modules/d3-shape/src/curve/catmullRomClosed.js","./curve/catmullRomOpen":"../node_modules/d3-shape/src/curve/catmullRomOpen.js","./curve/catmullRom":"../node_modules/d3-shape/src/curve/catmullRom.js","./curve/linearClosed":"../node_modules/d3-shape/src/curve/linearClosed.js","./curve/linear":"../node_modules/d3-shape/src/curve/linear.js","./curve/monotone":"../node_modules/d3-shape/src/curve/monotone.js","./curve/natural":"../node_modules/d3-shape/src/curve/natural.js","./curve/step":"../node_modules/d3-shape/src/curve/step.js","./stack":"../node_modules/d3-shape/src/stack.js","./offset/expand":"../node_modules/d3-shape/src/offset/expand.js","./offset/diverging":"../node_modules/d3-shape/src/offset/diverging.js","./offset/none":"../node_modules/d3-shape/src/offset/none.js","./offset/silhouette":"../node_modules/d3-shape/src/offset/silhouette.js","./offset/wiggle":"../node_modules/d3-shape/src/offset/wiggle.js","./order/appearance":"../node_modules/d3-shape/src/order/appearance.js","./order/ascending":"../node_modules/d3-shape/src/order/ascending.js","./order/descending":"../node_modules/d3-shape/src/order/descending.js","./order/insideOut":"../node_modules/d3-shape/src/order/insideOut.js","./order/none":"../node_modules/d3-shape/src/order/none.js","./order/reverse":"../node_modules/d3-shape/src/order/reverse.js"}],"../src/utils/colors.js":[function(require,module,exports) {
var colors = ['coral', 'skyblue', '#66c2a5', 'tan', '#8da0cb', '#e78ac3', '#a6d854', '#ffd92f', 'coral', 'skyblue', 'tan', 'orange'];
module.exports = {
  colors: colors
};
},{}],"../src/utils/addLegend.js":[function(require,module,exports) {
"use strict";

var _d3Selection = require("d3-selection");

var addLegend = function addLegend(parent, legendItems, legendWidth, legendHeight, left) {
  parent.svg.append('svg').attr('x', parent.legendPosition === 'left' ? 5 : parent.width - (legendWidth + 2)).attr('y', 0); // allow custom left-padding where chart overlaps with y-axis

  var leftPadding = left === undefined ? -parent.margin.left + 5 : left;
  var nodeLegend = parent.rc.rectangle(parent.legendPosition === 'left' ? leftPadding : // left
  ...
  var roughLegend = parent.roughSvg.appendChild(nodeLegend);
  var legendClass = 'rough' + parent.el.substring(1, parent.el.length);
  roughLegend.setAttribute('class', legendClass);
  legendItems.forEach(function (item, i) {
    var g = (0, _d3Selection.select)('.' + legendClass).append('g').attr('transform', "translate(\n        ".concat(parent.legendPosition === 'left' ? 5 : parent.width - (legendWidth + 2), ",\n        ", 0, ")"));
    g.append('rect').style('fill', parent.colors[i]).attr('width', 20).attr('height', 8).attr('x', parent.legendPosition === 'left' ? leftPadding : parent.margin.right + 5).attr('y', 6 + 11 * i - parent.margin.top / 3);
    g.append('text').style('font-size', '.8rem').style('font-family', parent.fontFamily).attr('x', parent.legendPosition === 'left' ? leftPadding + 25 : parent.margin.right + 30).attr('y', 6 + 11 * i + 8 - parent.margin.top / 3).text(item.text);
  });
};
...
},{"d3-selection":"../node_modules/d3-selection/src/index.js"}],"../src/Donut.js":[function(require,module,exports) {
"use strict";
...
var _addLegend = require("./utils/addLegend");
...
function (_Chart) {
  ...
  function Donut(opts) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Donut).call(this, opts)); // load in arguments from config object
    // this.data = opts.data;
    ...
    _this.colors = (0, _lodash.default)(opts, 'colors', _colors.colors);
    _this.highlight = opts.highlight;
    _this.roughness = (0, _roughCeiling.roughCeiling)({
      roughness: opts.roughness,
      ceiling: 30
    });
    _this.strokeWidth = (0, _lodash.default)(opts, 'strokeWidth', 0.75);
    _this.innerStrokeWidth = (0, _lodash.default)(opts, 'innerStrokeWidth', 0.75);
    _this.fillWeight = (0, _lodash.default)(opts, 'fillWeight', 0.85);
    _this.labels = _this.dataFormat === 'object' ? 'labels' : opts.labels;
    _this.values = _this.dataFormat === 'object' ? 'values' : opts.values;

    if (_this.labels === undefined || _this.values === undefined) {
      console.log("Error for ".concat(_this.el, ": Must include labels and values when        instantiating Donut chart. Skipping chart."));
      return _possibleConstructorReturn(_this);
    }

    _this.legend = opts.legend !== false;
    _this.legendPosition = (0, _lodash.default)(opts, 'legendPosition', 'right'); // new width
  ...
  _createClass(Donut, [{
    ...
    key: "setTitle",
    value: function setTitle(title) {
      this.svg.append('text').attr('x', this.width / 2).attr('y', 0 - this.margin.top / 3).attr('class', 'title').attr('text-anchor', 'middle').style('font-size', this.titleFontSize === undefined ? "".concat(Math.min(40, Math.min(this.width, this.height) / 4), "px") : this.titleFontSize).style('font-family', this.fontFamily).style('opacity', 0.8).text(title);
    }
  }, {
    key: "addInteraction",
    value: function addInteraction() {
      (0, _d3Selection.selectAll)(this.interactionG).append('g').attr('transform', "translate(".concat(this.width / 2, ", ").concat(this.height / 2, ")")).data(this.dataFormat === 'object' ? this.makePie(this.data[this.values]) : this.makePie(this.data)).append('path').attr('d', this.makeArc).attr('stroke-width', '0px').attr('fill', 'transparent'); // create tooltip
      ...
      (0, _d3Selection.selectAll)(this.interactionG).on('mouseover', function () {
        ...
        that.highlight === undefined ? (0, _d3Selection.select)(this).selectAll('path').style('opacity', 0.5) : (0, _d3Selection.select)(this).selectAll('path').style('stroke', that.highlight);
      });
      (0, _d3Selection.selectAll)(this.interactionG).on('mouseout', function () {
        mouseleave();
        (0, _d3Selection.select)(this).selectAll('path').style('stroke', thisColor);
        (0, _d3Selection.select)(this).selectAll('path').style('opacity', 1);
      });
      (0, _d3Selection.selectAll)(this.interactionG).on('mousemove', mousemove);
    }
  }, {
    ...
    value: function drawFromObject() {
      ...
      this.arcs.forEach(function (d, i) {
        if (d.value !== 0) {
          var node = _this3.rc.arc(_this3.width / 2, // x
          _this3.height / 2, // y
          2 * _this3.radius, // width
          2 * _this3.radius, // height
          d.startAngle - Math.PI / 2, // start
          d.endAngle - Math.PI / 2, // stop
          true, {
            fill: _this3.colors[i],
            stroke: _this3.colors[i]
          });

          node.setAttribute('class', _this3.graphClass);

          var roughNode = _this3.roughSvg.appendChild(node);

          roughNode.setAttribute('attrY', _this3.data[_this3.values][i]);
          roughNode.setAttribute('attrX', _this3.data[_this3.labels][i]);
        }
      });
      var donutNode = this.rc.circle(this.width / 2, this.height / 2, this.radius, {
        fill: 'white',
        strokeWidth: 0.05,
        fillWeight: 10,
        fillStyle: 'solid'
      ...
      (0, _d3Selection.selectAll)(this.interactionG).selectAll('path:nth-child(2)').style('stroke-width', this.strokeWidth); // ADD LEGEND

      var dataSources = this.data.labels;
      var legendItems = dataSources.map(function (key, i) {
        return {
          color: _this3.colors[i],
          text: key
        };
      }); // find length of longest text item

      var legendWidth = legendItems.reduce(function (pre, cur) {
        return pre > cur.text.length ? pre : cur.text.length;
      }, 0) * 6 + 35;
      var legendHeight = legendItems.length * 11 + 8;

      if (this.legend === true) {
        (0, _addLegend.addLegend)(this, legendItems, legendWidth, legendHeight);
    ...
    value: function drawFromFile() {
      ...
      this.arcs.forEach(function (d, i) {
        if (d.value !== 0) {
          var node = _this4.rc.arc(_this4.width / 2, // x
          _this4.height / 2, // y
          2 * _this4.radius, // width
          2 * _this4.radius, // height
          d.startAngle - Math.PI / 2, // start
          d.endAngle - Math.PI / 2, // stop
          true, {
            fill: _this4.colors[i],
            stroke: _this4.colors[i]
          });

          node.setAttribute('class', _this4.graphClass);

          var roughNode = _this4.roughSvg.appendChild(node);

          roughNode.setAttribute('attrY', d.data[_this4.values]);
          roughNode.setAttribute('attrX', d.data[_this4.labels]);
        }

        valueArr.push(d.data[_this4.labels]);
...
var _default = Donut;
exports.default = _default;
},{"d3-fetch":"../node_modules/d3-fetch/src/index.js","d3-selection":"../node_modules/d3-selection/src/index.js","d3-shape":"../node_modules/d3-shape/src/index.js","roughjs/bundled/rough.esm.js":"../node_modules/roughjs/bundled/rough.esm.js","lodash.get":"../node_modules/lodash.get/index.js","./Chart":"../src/Chart.js","./utils/colors":"../src/utils/colors.js","./utils/addLegend":"../src/utils/addLegend.js","./utils/roughCeiling":"../src/utils/roughCeiling.js"}],"../src/Line.js":[function(require,module,exports) {
"use strict";
...
var allDataExtent = function allDataExtent(data) {
  // get extend for all keys in data
  var keys = Object.keys(data);
  var extents = keys.map(function (key) {
    return (0, _d3Array.extent)(data[key]);
  });
  var dataMin = (0, _d3Array.min)(extents, function (d) {
    return d[0];
  });
  var dataMax = (0, _d3Array.max)(extents, function (d) {
    return d[1];
  });
...
function (_Chart) {
  ...
  function Line(opts) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Line).call(this, opts)); // load in arguments from config object
    ...
    _this.axisStrokeWidth = (0, _lodash.default)(opts, 'axisStrokeWidth', 0.4);
    _this.axisRoughness = (0, _lodash.default)(opts, 'axisRoughness', 0.9);
    _this.stroke = (0, _lodash.default)(opts, 'stroke', 'black');
    _this.fillWeight = (0, _lodash.default)(opts, 'fillWeight', 0.85);
    _this.colors = opts.colors;
    _this.strokeWidth = (0, _lodash.default)(opts, 'strokeWidth', 8);
    _this.axisFontSize = opts.axisFontSize;
    _this.x = opts.x;
    _this.y = _this.dataFormat === 'object' ? 'y' : opts.y;
    _this.xValueFormat = opts.xValueFormat;
    _this.yValueFormat = opts.yValueFormat;
    _this.legend = opts.legend !== false;
    _this.legendPosition = (0, _lodash.default)(opts, 'legendPosition', 'right');
    _this.circle = opts.circle !== false;
    _this.circleRadius = (0, _lodash.default)(opts, 'circleRadius', 10);
    _this.circleRoughness = (0, _roughCeiling.roughCeiling)({
      roughness: opts.circleRoughness,
      defaultValue: 2
    });
    _this.xLabel = (0, _lodash.default)(opts, 'xLabel', '');
    _this.yLabel = (0, _lodash.default)(opts, 'yLabel', '');
    _this.labelFontSize = (0, _lodash.default)(opts, 'labelFontSize', '1rem');

    if (_this.dataFormat === 'file') {
      _this.dataSources = [];
      _this.yKeys = Object.keys(opts).filter(function (name) {
        return /y/.test(name);
      });

      _this.yKeys.map(function (key, i) {
        if (key !== 'yLabel') _this.dataSources.push(opts[key]);
      });
    }
  ...
  _createClass(Line, [{
    ...
    value: function addScales() {
      ...
      if (this.dataFormat !== 'file') {
        ...
        var extents = this.dataSources.map(function (key) {
          return (0, _d3Array.extent)(_this3.data, function (d) {
            return +d[key];
          });
        });
        var dataMin = (0, _d3Array.min)(extents, function (d) {
      ...
      if (this.x === undefined) {
        ...
        var lengths = keys.map(function (key) {
          return _this3.data[key].length;
        });
        var maxLen = (0, _d3Array.max)(lengths); // Need to make xScale, when this.x is given, ordinal.

        xExtent = this.dataFormat === 'file' ? [0, this.data.length] : [0, maxLen];
      } else {
        xExtent = (0, _d3Array.extent)(this.x);
      }

      var yExtent = dataExtent;
      var yRange = yExtent[1] - yExtent[0];
      this.xScale = this.x === undefined ? (0, _d3Scale.scalePoint)().range([0, this.width]).domain(_toConsumableArray(Array(xExtent[1]).keys())) : (0, _d3Scale.scalePoint)().range([0, this.width]).domain(this.x);
      this.yScale = (0, _d3Scale.scaleLinear)().range([this.height, 0]).domain([0, yExtent[1] + yRange * 0.05]);
    }
  }, {
    key: "addLabels",
    value: function addLabels() {
      // xLabel
      if (this.xLabel !== '') {
        this.svg.append('text').attr('x', this.width / 2).attr('y', this.height + this.margin.bottom / 1.3).attr('dx', '1em').attr('class', 'labelText').style('text-anchor', 'middle').style('font-family', this.fontFamily).style('font-size', this.labelFontSize).text(this.xLabel);
      }

      ; // yLabel

      if (this.yLabel !== '') {
        this.svg.append('text').attr('transform', 'rotate(-90)').attr('y', 0 - this.margin.left / 2).attr('x', 0 - this.height / 2).attr('dy', '1em').attr('class', 'labelText').style('text-anchor', 'middle').style('font-family', this.fontFamily).style('font-size', this.labelFontSize).text(this.yLabel);
      }
    ...
    value: function addAxes() {
      ...
      var xAxis = (0, _d3Axis.axisBottom)(this.xScale).tickSize(0).tickFormat(function (d) {
        return _this4.xValueFormat ? (0, _d3Format.format)(_this4.xValueFormat)(d) : d;
      });
      var yAxis = (0, _d3Axis.axisLeft)(this.yScale).tickSize(0).tickFormat(function (d) {
        return _this4.yValueFormat ? (0, _d3Format.format)(_this4.yValueFormat)(d) : d;
      }); // x-axis

      this.svg.append('g').attr('transform', 'translate(0,' + this.height + ')').call(xAxis).attr('class', "xAxis".concat(this.graphClass)).selectAll('text').attr('transform', 'translate(-10, 0)rotate(-45)').style('text-anchor', 'end').style('font-family', this.fontFamily).style('font-size', this.axisFontSize === undefined ? "".concat(Math.min(0.95, Math.min(this.width, this.height) / 140), "rem") : this.axisFontSize); // y-axis

      this.svg.append('g').call(yAxis).attr('class', "yAxis".concat(this.graphClass)).selectAll('text').style('font-family', this.fontFamily).style('font-size', this.axisFontSize === undefined ? "".concat(Math.min(0.95, Math.min(this.width, this.height) / 140), "rem") : this.axisFontSize); // hide original axes

      (0, _d3Selection.selectAll)('path.domain').attr('stroke', 'transparent');
      (0, _d3Selection.selectAll)('g.tick').style('opacity', 1);
    }
  }, {
    key: "makeAxesRough",
    value: function makeAxesRough(roughSvg, rcAxis) {
    ...
    key: "setTitle",
    value: function setTitle(title) {
      this.svg.append('text').attr('x', this.width / 2).attr('y', 0 - this.margin.top / 2).attr('text-anchor', 'middle').style('font-size', this.titleFontSize === undefined ? "".concat(Math.min(20, Math.min(this.width, this.height) / 4), "px") : this.titleFontSize).style('font-family', this.fontFamily).style('opacity', 0.8).text(title);
    }
  }, {
    key: "addInteraction",
    value: function addInteraction() {
      ...
      this.dataSources.map(function (key, idx) {
        var points = _this5.data[key].map(function (d, i) {
          return _this5.x === undefined ? [_this5.xScale(i), _this5.yScale(d[key])] : [_this5.xScale(_this5.x[i]), _this5.yScale(+d[key])];
        }); // remove undefined elements so no odd behavior


        var drawPoints = points.filter(function (d) {
        ...
        _this5.svg.append('path').datum(drawPoints).attr('fill', 'none').attr('stroke', 'blue').attr('stroke-width', 1.5).attr('d', lineGen).attr('visibility', 'hidden'); // create tracking class (for interaction)


        var iClass = key + 'class'; // create hover text

        _this5.svg.append('g').attr('class', iClass + 'text').append('text').style('font-size', _this5.tooltipFontSize).style('opacity', 0).style('font-family', _this5.fontFamily).attr('text-anchor', 'middle').attr('alignment-baseline', 'middle');
      });

      var mousemove = function mousemove(d) {
        // recover coordinate we need
        var xPos = (0, _d3Selection.mouse)(this)[0];
        var domain = that.xScale.domain();
        var xRange = that.xScale.range();
        var rangePoints = (0, _d3Array.range)(xRange[0], xRange[1] + 1, that.xScale.step());
        var xSpot = (0, _d3Array.bisect)(rangePoints, xPos);
        var yPos = domain[xSpot];
        that.dataSources.map(function (key, i) {
          var hoverData = that.dataFormat === 'file' ? that.x === undefined ? that.data[yPos] : that.data[xSpot] : that.data[key][xSpot]; // resolve select classes for hover effects

          var thatClass = '.' + key + 'class';
          var textClass = thatClass + 'text';

          if (that.dataFormat === 'file') {
            (0, _d3Selection.select)(textClass).selectAll('text').style('opacity', 1).html(that.x === undefined ? "(".concat(xSpot, ",").concat(hoverData[key], ")") : "(".concat(that.x[xSpot], ", ").concat(hoverData[key], ")")).attr('x', that.x === undefined ? that.xScale(xSpot) : that.xScale(that.x[xSpot])).attr('y', that.yScale(hoverData[key]) - 6);
          } else {
            (0, _d3Selection.select)(textClass).selectAll('text').style('opacity', 1).html(that.x === undefined ? "(".concat(xSpot, ", ").concat(hoverData, ")") : "(".concat(that.x[xSpot], ", ").concat(hoverData, ")")).attr('x', that.x === undefined ? that.xScale(xSpot) : that.xScale(that.x[xSpot])).attr('y', that.yScale(hoverData));
          }
        });
      };

      this.chartScreen.append('rect').attr('width', this.width).attr('height', this.height).attr('fill', 'none').on('mousemove', mousemove).on('mouseout', function () {
        that.dataSources.map(function (key) {
          var thatClass = '.' + key + 'class';
          var textClass = thatClass + 'text';
          (0, _d3Selection.select)(textClass).selectAll('text').style('opacity', 0);
        });
      });
    }
  }, {
    ...
    value: function drawFromObject() {
      ...
      // set default color
      if (this.colors === undefined) this.colors = _colors.colors;
      this.dataSources = Object.keys(this.data);
      this.initRoughObjects();
      this.addScales();
      this.dataSources.map(function (key, idx) {
        var points = _this6.data[key].map(function (d, i) {
          return _this6.x === undefined ? [_this6.xScale(i), _this6.yScale(+d)] : [_this6.xScale(_this6.x[i]), _this6.yScale(d)];
        }); // remove undefined elements so no odd behavior
        ...
        var node = _this6.rc.curve(drawPoints, {
          stroke: _this6.colors.length === 1 ? _this6.colors[0] : _this6.colors[idx],
          roughness: _this6.roughness,
          bowing: _this6.bowing
        });
        ...
        if (_this6.circle === true) {
          points.forEach(function (d, i) {
            var node = _this6.rc.circle(d[0], d[1], _this6.circleRadius, {
              stroke: _this6.colors[idx],
              fill: _this6.colors[idx],
              fillStyle: 'solid',
              strokeWidth: 1,
              roughness: _this6.circleRoughness
            });

            _this6.roughSvg.appendChild(node);
          });
        }
      ...
      var legendItems = this.dataSources.map(function (key, i) {
        return {
      ...
      if (this.legend === true) {
        (0, _addLegend.addLegend)(this, legendItems, legendWidth, legendHeight, 2);
      }
    ...
    value: function drawFromFile() {
      ...
      if (this.colors === undefined) this.colors = _colors.colors;
      this.initRoughObjects();
      this.addScales(); // Add scatterplot

      this.dataSources.map(function (key, idx) {
        var points = _this7.data.map(function (d, i) {
          return _this7.x === undefined ? [_this7.xScale(i), _this7.yScale(d[key])] : [_this7.xScale(_this7.x[i]), _this7.yScale(+d[key])];
        }); // remove undefined elements so no odd behavior
        ...
        var node = _this7.rc.curve(drawPoints, {
          stroke: _this7.colors[idx],
          strokeWidth: _this7.strokeWidth,
          roughness: 1,
          bowing: 10
        });

        _this7.roughSvg.appendChild(node);

        if (_this7.circle === true) {
          drawPoints.forEach(function (d, i) {
            var node = _this7.rc.circle(d[0], d[1], _this7.circleRadius, {
              stroke: _this7.colors[idx],
              fill: _this7.colors[idx],
              fillStyle: 'solid',
              strokeWidth: 1,
              roughness: _this7.circleRoughness
            });
...
var _default = Line;
exports.default = _default;
},{"d3-array":"../node_modules/d3-array/src/index.js","d3-axis":"../node_modules/d3-axis/src/index.js","d3-fetch":"../node_modules/d3-fetch/src/index.js","d3-format":"../node_modules/d3-format/src/index.js","d3-scale":"../node_modules/d3-scale/src/index.js","d3-selection":"../node_modules/d3-selection/src/index.js","d3-shape":"../node_modules/d3-shape/src/index.js","roughjs/bundled/rough.esm.js":"../node_modules/roughjs/bundled/rough.esm.js","lodash.get":"../node_modules/lodash.get/index.js","./Chart":"../src/Chart.js","./utils/addLegend":"../src/utils/addLegend.js","./utils/colors":"../src/utils/colors.js","./utils/roughCeiling":"../src/utils/roughCeiling.js"}],"../src/Pie.js":[function(require,module,exports) {
"use strict";
...
function (_Chart) {
  ...
  function Pie(opts) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Pie).call(this, opts)); // load in arguments from config object
    // this.data = opts.data;
  ...
  _createClass(Pie, [{
    ...
    value: function drawFromObject() {
      ...
      (0, _d3Selection.selectAll)(this.interactionG).selectAll('path:nth-child(2)').style('stroke-width', this.strokeWidth);
      var dataSources = this.data.labels; // ADD LEGEND
...
var _default = Pie;
exports.default = _default;
},{"d3-fetch":"../node_modules/d3-fetch/src/index.js","d3-selection":"../node_modules/d3-selection/src/index.js","d3-shape":"../node_modules/d3-shape/src/index.js","roughjs/bundled/rough.esm.js":"../node_modules/roughjs/bundled/rough.esm.js","lodash.get":"../node_modules/lodash.get/index.js","./Chart":"../src/Chart.js","./utils/colors":"../src/utils/colors.js","./utils/addLegend":"../src/utils/addLegend.js","./utils/roughCeiling":"../src/utils/roughCeiling.js"}],"../src/Scatter.js":[function(require,module,exports) {
"use strict";
...
var defaultColors = ['pink', 'skyblue', 'coral', 'gold', 'teal', 'grey', 'darkgreen', 'pink', 'brown', 'slateblue', 'grey1', 'orange'];

var Scatter =
/*#__PURE__*/
function (_Chart) {
  _inherits(Scatter, _Chart);
  ...
  function Scatter(opts) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Scatter).call(this, opts)); // load in arguments from config object
    // this.data = opts.data;
    ...
    _this.colorVar = opts.colorVar;
    _this.roughness = (0, _roughCeiling.roughCeiling)({
      roughness: opts.roughness
    });
    _this.highlight = opts.highlight;
    _this.highlightLabel = (0, _lodash.default)(opts, 'highlightLabel', 'xy');
    _this.radius = (0, _lodash.default)(opts, 'radius', 8);
    _this.axisStrokeWidth = (0, _lodash.default)(opts, 'axisStrokeWidth', 0.4);
    _this.axisRoughness = (0, _lodash.default)(opts, 'axisRoughness', 0.9);
    _this.curbZero = opts.curbZero === true;
    _this.innerStrokeWidth = (0, _lodash.default)(opts, 'innerStrokeWidth', 1);
    _this.stroke = (0, _lodash.default)(opts, 'stroke', 'black');
    _this.fillWeight = (0, _lodash.default)(opts, 'fillWeight', 0.85);
    _this.colors = opts.colors;
    _this.strokeWidth = (0, _lodash.default)(opts, 'strokeWidth', 1);
    _this.axisFontSize = opts.axisFontSize;
    _this.x = _this.dataFormat === 'object' ? 'x' : opts.x;
    _this.y = _this.dataFormat === 'object' ? 'y' : opts.y;
    _this.xValueFormat = opts.xValueFormat;
    _this.yValueFormat = opts.yValueFormat;
    _this.xLabel = (0, _lodash.default)(opts, 'xLabel', '');
  ...
  _createClass(Scatter, [{
    ...
    value: function addScales() {
      ...
      // get value domains and pad axes by 5%
      var xExtent = this.dataFormat === 'file' ? (0, _d3Array.extent)(this.data, function (d) {
        return +d[_this3.x];
      }) : (0, _d3Array.extent)(this.data[this.x]);
      var xRange = xExtent[1] - xExtent[0];
      var yExtent = this.dataFormat === 'file' ? (0, _d3Array.extent)(this.data, function (d) {
        return +d[_this3.y];
      }) : (0, _d3Array.extent)(this.data[this.y]);
      var yRange = yExtent[1] - yExtent[0];
      var colorExtent = this.dataFormat === 'file' ? (0, _d3Array.extent)(this.data, function (d) {
        return d[_this3.colorVar];
      }) : [1, 1];

      if (this.dataFormat === 'file') {
        var radiusExtent = (0, _d3Array.extent)(this.data, function (d) {
          return +d[_this3.radius];
        });
        var radiusMax = Math.min(this.width, this.height) / 2 / 2;
        this.radiusScale = (0, _d3Scale.scaleLinear)().range([8, radiusMax]).domain(radiusExtent);
      ...
      ;
      this.xScale = (0, _d3Scale.scaleLinear)().range([0, this.width]).domain([xExtent[0] - xRange * 0.05, xExtent[1] + xRange * 0.05]);
      this.yScale = (0, _d3Scale.scaleLinear)().range([this.height, 0]).domain([yExtent[0] - yRange * 0.05, yExtent[1] + yRange * 0.05]);
      this.colorScale = (0, _d3Scale.scaleOrdinal)().range(this.colors).domain(colorExtent);
    }
  }, {
    key: "addLabels",
    value: function addLabels() {
    ...
    value: function addInteraction() {
      ...
      // add highlight helper dom nodes
      var circles = (0, _d3Selection.selectAll)(this.interactionG).data(this.dataFormat === 'file' ? this.data : this.data.x).append('circle').attr('cx', function (d, i) {
        return _this5.dataFormat === 'file' ? _this5.xScale(+d[_this5.x]) : _this5.xScale(+_this5.data[_this5.x][i]);
      }).attr('cy', function (d, i) {
        return _this5.dataFormat === 'file' ? _this5.yScale(+d[_this5.y]) : _this5.yScale(+_this5.data[_this5.y][i]);
      });

      if (this.dataFormat === 'file') {
        circles.attr('r', function (d) {
          return typeof _this5.radius === 'number' ? _this5.radius * 0.7 : _this5.radiusScale(+d[_this5.radius]) * 0.6;
        }).attr('fill', 'transparent');
      } else {
        circles.attr('r', function (d, i) {
          return typeof _this5.radius === 'number' ? _this5.radius * 0.7 : _this5.radius[i] * 0.6;
        }).attr('fill', 'transparent');
      }
      ...
      var mousemove = function mousemove(d) {
        var attrX = (0, _d3Selection.select)(this).attr('attrX');
        var attrY = (0, _d3Selection.select)(this).attr('attrY');
        var attrHighlightLabel = (0, _d3Selection.select)(this).attr('attrHighlightLabel');
        var mousePos = (0, _d3Selection.mouse)(this); // get size of enclosing div

        Tooltip.html(that.highlightLabel === 'xy' ? "<b>x</b>: ".concat(attrX, " <br><b>y</b>: ").concat(attrY) : "<b>".concat(attrHighlightLabel, "</b>")).attr('class', function (d) {}).style('transform', "translate(".concat(mousePos[0] + that.margin.left, "px, \n          ").concat(mousePos[1] - (that.height + that.margin.top + that.margin.bottom), "px)"));
      };
      ...
      (0, _d3Selection.selectAll)(this.interactionG).on('mouseover', function () {
        mouseover();
        thisColor = (0, _d3Selection.select)(this).selectAll('path').style('stroke');
        that.highlight === undefined ? (0, _d3Selection.select)(this).selectAll('path:nth-child(1)').style('opacity', 0.4) : (0, _d3Selection.select)(this).selectAll('path:nth-child(1)').style('stroke', that.highlight);
        (0, _d3Selection.select)(this).selectAll('path:nth-child(2)').style('stroke-width', that.strokeWidth + 1.2);
      });
      (0, _d3Selection.selectAll)(this.interactionG).on('mouseout', function () {
        mouseleave();
        (0, _d3Selection.select)(this).selectAll('path').style('opacity', 1);
        (0, _d3Selection.select)(this).selectAll('path:nth-child(1)').style('stroke', thisColor); // highlight stroke back to its color

        (0, _d3Selection.select)(this).selectAll('path:nth-child(2)').style('stroke', that.stroke);
        (0, _d3Selection.select)(this).selectAll('path:nth-child(2)').style('stroke-width', that.strokeWidth);
      });
      (0, _d3Selection.selectAll)(this.interactionG).on('mousemove', mousemove);
    }
    ...
    value: function drawFromObject() {
      ...
      this.addAxes();
      this.makeAxesRough(this.roughSvg, this.rcAxis);
      this.addLabels(); // Add scatterplot

      this.data.x.forEach(function (d, i) {
        var node = _this6.rc.circle(_this6.xScale(+d), _this6.yScale(+_this6.data[_this6.y][i]), typeof _this6.radius === 'number' ? _this6.radius : _this6.radius[i], {
          fill: typeof _this6.colors === 'string' ? _this6.colors : _this6.colors.length === 1 ? _this6.colors[0] : _this6.colors[i],
          simplification: _this6.simplification,
          fillWeight: _this6.fillWeight
        });
        ...
        roughNode.setAttribute('attrY', _this6.data[_this6.y][i]);
        roughNode.setAttribute('attrHighlightLabel', _this6.data[_this6.highlightLabel]);
      });
      (0, _d3Selection.selectAll)(this.interactionG).selectAll('path:nth-child(2)').style('stroke-width', this.strokeWidth); // If desired, add interactivity
    ...
    value: function drawFromFile() {
      ...
      this.data.forEach(function (d, i) {
        var node = _this7.rc.circle(_this7.xScale(+d[_this7.x]), _this7.yScale(+d[_this7.y]), typeof _this7.radius === 'number' ? _this7.radius : _this7.radiusScale(+d[_this7.radius]), {
          fill: _this7.colorVar === undefined ? _this7.colors[0] : _this7.colorScale(d[_this7.colorVar]),
          simplification: _this7.simplification,
          fillWeight: _this7.fillWeight
        });

        var roughNode = _this7.roughSvg.appendChild(node);

        roughNode.setAttribute('class', _this7.graphClass);
        roughNode.setAttribute('attrX', d[_this7.x]);
        roughNode.setAttribute('attrY', d[_this7.y]);
        roughNode.setAttribute('attrHighlightLabel', d[_this7.highlightLabel]);
      });
      (0, _d3Selection.selectAll)(this.interactionG).selectAll('path:nth-child(2)').style('stroke-width', this.strokeWidth); // If desired, add interactivity
...
exports.default = _default;
},{"d3-array":"../node_modules/d3-array/src/index.js","d3-axis":"../node_modules/d3-axis/src/index.js","d3-fetch":"../node_modules/d3-fetch/src/index.js","d3-format":"../node_modules/d3-format/src/index.js","d3-scale":"../node_modules/d3-scale/src/index.js","d3-selection":"../node_modules/d3-selection/src/index.js","roughjs/bundled/rough.esm.js":"../node_modules/roughjs/bundled/rough.esm.js","lodash.get":"../node_modules/lodash.get/index.js","./Chart":"../src/Chart.js","./utils/roughCeiling":"../src/utils/roughCeiling.js"}],"../src/StackedBar.js":[function(require,module,exports) {
"use strict";
...
function (_Chart) {
  ...
  function StackedBar(opts) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(StackedBar).call(this, opts)); // load in arguments from config object
    ...
    _this.fillWeight = (0, _lodash.default)(opts, 'fillWeight', 0.5);
    _this.axisFontSize = opts.axisFontSize;
    _this.labels = opts.labels;
    _this.values = opts.values;
    _this.stackColorMapping = {};
    _this.padding = (0, _lodash.default)(opts, 'padding', 0.1);
    _this.xLabel = (0, _lodash.default)(opts, 'xLabel', '');
    _this.yLabel = (0, _lodash.default)(opts, 'yLabel', '');
    _this.labelFontSize = (0, _lodash.default)(opts, 'labelFontSize', '1rem'); // new width
  ...
  _createClass(StackedBar, [{
    ...
    key: "updateColorMapping",
    value: function updateColorMapping(label) {
      if (!this.stackColorMapping[label]) {
        // If there isn't a color already mapped to the label then use the next color available
        this.stackColorMapping[label] = _colors.colors[Object.keys(this.stackColorMapping).length];
      }
    } // add this to abstract base
    ...
    value: function addScales() {
      ...
      this.xScale = (0, _d3Scale.scaleBand)().rangeRound([0, this.width]).padding(this.padding).domain(this.data.map(function (d) {
        return d[_this3.labels];
      }));
      ...
      var keys = this.dataFormat === 'object' ? this.data.map(function (d) {
        return d[_this3.labels];
      }) : this.data.columns;
      this.zScale = (0, _d3Scale.scaleOrdinal)().range(['#98abc5', '#8a89a6', '#7b6888', '#6b486b', '#a05d56', '#d0743c', '#ff8c00']).domain(keys);
    }
  }, {
    key: "addLabels",
    value: function addLabels() {
    ...
    key: "addAxes",
    value: function addAxes() {
      var xAxis = (0, _d3Axis.axisBottom)(this.xScale).tickSize(0); // x-axis

      this.svg.append('g').attr('transform', 'translate(0,' + this.height + ')').call(xAxis).attr('class', "xAxis".concat(this.graphClass)).selectAll('text').attr('transform', 'translate(-10,0)rotate(-45)').style('text-anchor', 'end').style('font-family', this.fontFamily).style('font-size', this.axisFontSize === undefined ? "".concat(Math.min(0.8, Math.min(this.width, this.height) / 140), "rem") : this.axisFontSize).style('opacity', 0.9); // y-axis

      var yAxis = (0, _d3Axis.axisLeft)(this.yScale).tickSize(0);
      this.svg.append('g').call(yAxis).attr('class', "yAxis".concat(this.graphClass)).selectAll('text').style('font-family', this.fontFamily).style('font-size', this.axisFontSize === undefined ? "".concat(Math.min(0.95, Math.min(this.width, this.height) / 140), "rem") : this.axisFontSize).style('opacity', 0.9); // hide original axes
    ...
    key: "addInteraction",
    value: function addInteraction() {
      (0, _d3Selection.selectAll)(this.interactionG) // .data(this.data)
      // .append('rect')
      .each(function (d, i) {
        var attr = this['attributes'];
        (0, _d3Selection.select)(this).append('rect').attr('x', attr['x'].value).attr('y', attr['y'].value).attr('width', attr['width'].value).attr('height', attr['height'].value).attr('fill', 'transparent');
      }); // create tooltip
      ...
      var mousemove = function mousemove(d) {
        var attrX = (0, _d3Selection.select)(this).attr('attrX');
        var attrY = (0, _d3Selection.select)(this).attr('attrY');
        var keyY = (0, _d3Selection.select)(this).attr('keyY');
        var mousePos = (0, _d3Selection.mouse)(this); // get size of enclosing div

        Tooltip.html("<h4>".concat(attrX, "</h4> <b>").concat(keyY, "</b>: ").concat(attrY)).style('opacity', 0.95).attr('class', function (d) {}).style('transform', "translate(".concat(mousePos[0] + that.margin.left, "px, \n          ").concat(mousePos[1] - (that.height + that.margin.top + that.margin.bottom), "px)"));
      };
      ...
      (0, _d3Selection.selectAll)(this.interactionG).on('mouseout', function () {
        mouseleave();
        (0, _d3Selection.select)(this).select('path').style('stroke', thisColor);
        (0, _d3Selection.select)(this).selectAll('path:nth-child(2)').style('stroke-width', that.strokeWidth);
      });
      (0, _d3Selection.selectAll)(this.interactionG).on('mousemove', mousemove);
    }
    ...
    value: function stacking() {
      ...
      this.data.forEach(function (d) {
        ...
        var yStack = 0;
        keys.forEach(function (yValue, i) {
          if (i > 0 && yValue !== 'total') {
            yStack += parseInt(d[yValue], 10);

            var x = _this4.xScale(d[_this4.labels]);

            var y = _this4.yScale(yStack);

            var width = _this4.xScale.bandwidth();

            var height = _this4.height - _this4.yScale(+d[yValue]);

            var node = _this4.rc.rectangle(x, y, width, height, {
              fill: _this4.stackColorMapping[yValue] || _this4.colors[i],
              stroke: _this4.stackColorMapping[yValue] || _this4.colors[i],
              simplification: _this4.simplification,
              fillWeight: _this4.fillWeight
            });

            var roughNode = _this4.roughSvg.appendChild(node);

            roughNode.setAttribute('class', _this4.graphClass);
            roughNode.setAttribute('attrX', d[_this4.labels]);
            roughNode.setAttribute('keyY', yValue);
            roughNode.setAttribute('attrY', +d[yValue]); // Set Attributes to access them later
    ...
    value: function drawFromObject() {
      ...
      this.addAxes();
      this.makeAxesRough(this.roughSvg, this.rcAxis);
      this.addLabels(); // Add Stackedbarplot
...
var _default = StackedBar;
exports.default = _default;
},{"d3-array":"../node_modules/d3-array/src/index.js","d3-axis":"../node_modules/d3-axis/src/index.js","d3-fetch":"../node_modules/d3-fetch/src/index.js","d3-scale":"../node_modules/d3-scale/src/index.js","d3-selection":"../node_modules/d3-selection/src/index.js","roughjs/bundled/rough.esm.js":"../node_modules/roughjs/bundled/rough.esm.js","lodash.get":"../node_modules/lodash.get/index.js","./Chart":"../src/Chart.js","./utils/colors":"../src/utils/colors.js","./utils/roughCeiling":"../src/utils/roughCeiling.js"}],"../src/index.js":[function(require,module,exports) {
"use strict";
...
module.exports = {
  Bar: _Bar.default,
  BarH: _BarH.default,
  Donut: _Donut.default,
  Line: _Line.default,
  Pie: _Pie.default,
  Scatter: _Scatter.default,
  StackedBar: _StackedBar.default
};
},{"./Bar":"../src/Bar.js","./BarH":"../src/BarH.js","./Donut":"../src/Donut.js","./Line":"../src/Line.js","./Pie":"../src/Pie.js","./Scatter":"../src/Scatter.js","./StackedBar":"../src/StackedBar.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
new _src.default.Scatter({
  ...
  font: 0,
  curbZero: false,
  fillStyle: 'crss-hatch' // highlight: 'blue'

});
new _src.default.Donut({
  element: '#vis1',
